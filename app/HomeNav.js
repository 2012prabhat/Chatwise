...
function HomeNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-8 py-4 back1">
      {/* Brand + Logo */}
      <div
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="absolute top-full left-0 w-full back1 flex flex-col items-center py-4 space-y-4 md:hidden">
          {["features", "how-it-works", "testimonials", "faq"].map((item) => (
            <li
              key={item}
